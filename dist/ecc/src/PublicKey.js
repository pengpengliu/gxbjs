...
var PublicKey = function () {
    ...
    function PublicKey(Q) {
        (0, _classCallCheck3.default)(this, PublicKey);
        this.Q = Q;
    }
    ...
    PublicKey.prototype.toString = function toString() {
        var address_prefix = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _gxbjsWs.ChainConfig.address_prefix;
    ...
    */
    ...
    PublicKey.fromPublicKeyString = function fromPublicKeyString(public_key) {
        var address_prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _gxbjsWs.ChainConfig.address_prefix;
