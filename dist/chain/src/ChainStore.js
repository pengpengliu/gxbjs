...
var object_type = _ChainTypes2.default.object_type,
    ...
    operations = _ChainTypes2.default.operations;
...
var free_data_product_object_type = parseInt(object_type.free_data_product, 10);
var league_data_product_object_type = parseInt(object_type.league_data_product, 10);
var data_transaction_object_type = parseInt(object_type.data_transaction, 10);
...
var free_data_product_prefix = "1." + free_data_product_object_type + ".";
var league_data_product_prefix = "1." + league_data_product_object_type + ".";
var data_transaction_prefix = "1." + data_transaction_object_type + ".";
...
var ChainStore = function () {
    function ChainStore() {
        (0, _classCallCheck3.default)(this, ChainStore);
         ...
         */
        this.subbed_accounts = new _set2.default();
        this.subbed_witnesses = new _set2.default();
        this.subbed_committee = new _set2.default();
    ...
    ChainStore.prototype.clearCache = function clearCache() {
        this.objects_by_id = new _map2.default();
        this.accounts_by_name = new _map2.default();
        this.assets_by_symbol = new _map2.default();
        this.account_ids_by_key = _immutable2.default.Map();
        this.balance_objects_by_address = new _map2.default();
        this.get_account_refs_of_keys_calls = new _set2.default();
        this.account_history_requests = new _map2.default(); ///< tracks pending history requests
        this.witness_by_account_id = new _map2.default();
        this.committee_by_account_id = new _map2.default();
        this.objects_by_vote_id = new _map2.default();
        this.fetching_get_full_accounts = new _map2.default();
    ...
    ChainStore.prototype.init = function init() {
        ...
        var _init = function _init(resolve, reject) {
            ...
            var db_api = _gxbjsWs.Apis.instance().db_api();
            if (!db_api) {
            ...
            return db_api.exec("get_objects", [["2.1.0"]]).then(function (optional_objects) {
                ...
                for (var i = 0; i < optional_objects.length; i++) {
                    ...
                    if (optional_object) {
                        ...
                        if (delta < 100) {
                            _gxbjsWs.Apis.instance().db_api().exec("set_subscribe_callback", [_this.onUpdate.bind(_this), true]).then(function () {
    ...
    ChainStore.prototype.getObject = function getObject(id) {
        ...
        if (!_ChainValidation2.default.is_object_id(id)) throw Error("argument is not an object id: " + (0, _stringify2.default)(id));
    ...
    ChainStore.prototype.getAsset = function getAsset(id_or_symbol) {
        ...
        _gxbjsWs.Apis.instance().db_api().exec("lookup_asset_symbols", [[id_or_symbol]]).then(function (asset_objects) {
    ...
    ChainStore.prototype.getAccountRefsOfKey = function getAccountRefsOfKey(key) {
        ...
        if (this.get_account_refs_of_keys_calls.has(key)) return this.account_ids_by_key.get(key);else {
            ...
            _gxbjsWs.Apis.instance().db_api().exec("get_key_references", [[key]]).then(function (vec_account_id) {
    ...
    ChainStore.prototype.getBalanceObjects = function getBalanceObjects(address) {
        ...
        if (current === undefined) {
            ...
            _gxbjsWs.Apis.instance().db_api().exec("get_balance_objects", [[address]]).then(function (balance_objects) {
    ...
    ChainStore.prototype.fetchObject = function fetchObject(id) {
        ...
        if (result === undefined) {
            ...
            _gxbjsWs.Apis.instance().db_api().exec("get_objects", [[id]]).then(function (optional_objects) {
                //if(DEBUG) console.log("... optional_objects",optional_objects ? optional_objects[0].id : null)
    ...
    ChainStore.prototype.getAccount = function getAccount(name_or_id) {
        ...
        if ((typeof name_or_id === "undefined" ? "undefined" : (0, _typeof3.default)(name_or_id)) === "object") {
    ...
    ChainStore.prototype.fetchWitnessByAccount = function fetchWitnessByAccount(account_id) {
        ...
        return new _promise2.default(function (resolve, reject) {
            _gxbjsWs.Apis.instance().db_api().exec("get_witness_by_account", [account_id]).then(function (optional_witness_object) {
    ...
    ChainStore.prototype.fetchCommitteeMemberByAccount = function fetchCommitteeMemberByAccount(account_id) {
        ...
        return new _promise2.default(function (resolve, reject) {
            _gxbjsWs.Apis.instance().db_api().exec("get_committee_member_by_account", [account_id]).then(function (optional_committee_object) {
    ...
    ChainStore.prototype.fetchFullAccount = function fetchFullAccount(name_or_id) {
        ...
        if (!this.fetching_get_full_accounts.has(name_or_id) || Date.now() - this.fetching_get_full_accounts.get(name_or_id) > 5000) {
            ...
            _gxbjsWs.Apis.instance().db_api().exec("get_full_accounts", [[name_or_id], true]).then(function (results) {
                if (results.length === 0) {
                    if (_ChainValidation2.default.is_object_id(name_or_id)) {
                ...
                var account = full_account.account,
                    ...
                    locked_balances = full_account.locked_balances,
                    pledge_balances = full_account.pledge_balances,
                ...
                account.locked_balances = new _immutable2.default.Set();
                account.pledge_balances = new _immutable2.default.Set();
                ...
                account.locked_balances = locked_balances;
                account.pledge_balances = pledge_balances;
                ...
                if (sub_to_objects.length) _gxbjsWs.Apis.instance().db_api().exec("get_objects", [sub_to_objects]);
    ...
    ChainStore.prototype.fetchRecentHistory = function fetchRecentHistory(account) {
        ...
        pending_request.promise = new _promise2.default(function (resolve, reject) {
            _gxbjsWs.Apis.instance().history_api().exec("get_account_history", [account_id, most_recent, limit, start]).then(function (operations) {
        ...
        if (object.id.substring(0, balance_prefix.length) == balance_prefix) {
            ...
            if (account) {
                ...
                if (!call_orders.has(object.id)) {
                    ...
                    this.objects_by_id.set(account.get("id"), account);
                    _gxbjsWs.Apis.instance().db_api().exec("get_objects", [[object.id]]); // Force subscription to the object in the witness node by calling get_objects
                }
            }
        } else if (object.id.substring(0, order_prefix.length) == order_prefix) {
            // LIMIT ORDER OBJECT
    ...
    ChainStore.prototype.getObjectsByVoteIds = function getObjectsByVoteIds(vote_ids) {
        ...
        if (missing.length) {
            ...
            _gxbjsWs.Apis.instance().db_api().exec("lookup_vote_ids", [missing]).then(function (vote_obj_array) {
