...
export const balance_lock = new Serializer('balance_lock', {
    fee: asset,
    locked_account: protocol_id_type("account"),
    create_time: time_point_sec,
    locked_time_type: string,
...
export const balance_unlock = new Serializer('balance_unlock', {
    fee: asset,
    unlocked_account: protocol_id_type("account"),
    account_balance_locked: protocol_id_type("account_balance_locked"),
    extensions: set(future_extensions)
})
